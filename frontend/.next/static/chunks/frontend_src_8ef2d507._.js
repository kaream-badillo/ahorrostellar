...
"[project]/frontend/src/lib/config.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/src/lib/stellar.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/config.ts [app-client] (ecmascript)");
;
;
;
// Stellar testnet configuration
const config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStellarConfig"])();
const STELLAR_TESTNET_URL = config.TESTNET_URL;
const NETWORK_PASSPHRASE = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$dist$2f$stellar$2d$sdk$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Networks"].TESTNET;
...
class StellarService {
    ...
    async connectWallet() {
        try {
            ...
            if ("object" !== 'undefined' && window.stellar) {
                ...
                const publicKey = await Promise.race([
                    ...
                    new Promise((_, reject)=>setTimeout(()=>reject(new Error('Wallet connection timeout')), 10000))
                ]);
    ...
    async createStakingTransaction(amount, projectId) {
        ...
        try {
            ...
            const memo = "STAKING:".concat(projectId, ":").concat(Date.now());
            // Create transaction for symbolic staking (using XLM)
            const transaction = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$dist$2f$stellar$2d$sdk$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TransactionBuilder"](account, {
                fee: '100',
                networkPassphrase: NETWORK_PASSPHRASE
            }).addOperation(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$dist$2f$stellar$2d$sdk$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Operation"].payment({
                destination: this.publicKey,
                asset: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$dist$2f$stellar$2d$sdk$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Asset"].native(),
                amount: amount.toString()
            })).addMemo(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$dist$2f$stellar$2d$sdk$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Memo"].text(memo)).setTimeout(30).build();
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "server", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "publicKey", null);
        try {
            this.server = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$stellar$2f$stellar$2d$sdk$2f$dist$2f$stellar$2d$sdk$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rpc"].Server(("TURBOPACK compile-time value", "https://soroban-testnet.stellar.org") || 'https://soroban-testnet.stellar.org', {
                allowHttp: true
            });
        } catch (error) {
...
"[project]/frontend/src/lib/friendbot.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/src/hooks/useWallet.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/stellar.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$friendbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/friendbot.ts [app-client] (ecmascript)");
...
const useWallet = ()=>{
    _s();
    const [walletState, setWalletState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        isConnected: false,
        publicKey: null,
        balance: null,
        isLoading: false,
    ...
    const isFreighterInstalled = ()=>{
        const hasFreighter = "object" !== 'undefined' && window.stellar;
    ...
    const connectWallet = async ()=>{
        ...
        try {
            ...
            const publicKey = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].connectWallet();
            console.log('✅ Account received:', publicKey);
            // Ensure account is funded (testnet only)
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$friendbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ensureFunded"])(publicKey);
            const balance = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].getBalance(publicKey);
    ...
    const createStaking = async (amount, projectId)=>{
        ...
        try {
            const transactionXDR = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].createStakingTransaction(amount, projectId);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].signAndSubmitTransaction(transactionXDR);
            // Update balance after transaction
            if (walletState.publicKey) {
                const newBalance = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].getBalance(walletState.publicKey);
                setWalletState((prev)=>({
                        ...prev,
                        balance: newBalance,
                        isLoading: false
    ...
    const issueReputation = async (amount, recipient)=>{
        ...
        try {
            const transactionXDR = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].issueReputationToken(amount, recipient);
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].signAndSubmitTransaction(transactionXDR);
            return result;
        } catch (error) {
    ...
    const getTransactionHistory = async ()=>{
        ...
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].getTransactionHistory(walletState.publicKey);
        } catch (error) {
            console.error('Error getting transaction history:', error);
            return [];
        }
        ...
        "useWallet.useEffect": ()=>{
            const autoConnect = {
                "useWallet.useEffect.autoConnect": async ()=>{
                    ...
                    await new Promise({
                        "useWallet.useEffect.autoConnect": (resolve)=>setTimeout(resolve, 100)
    ...
    }["useWallet.useEffect"], []); // connectWallet is stable, so this is safe
    return {
        ...walletState,
        connectWallet,
        disconnectWallet,
...
_s(useWallet, "xtZY7nTiZuVk8nrVI1D1Ld9UsXU=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/frontend/src/lib/mockData.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/src/contexts/AppContext.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/hooks/useWallet.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/stellar.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/src/lib/mockData.ts [app-client] (ecmascript)");
;
...
;
const realProjects = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockProjects"].map((project)=>({
...
function AppProvider(param) {
    ...
    const [state, setState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ...
        myStakedProjects: realProjects.filter({
            "AppProvider.useState": (p)=>p.myStake > 0
    ...
    const walletHook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"])();
    ...
    const makeStake = async (projectId, amount)=>{
        ...
        try {
            ...
            try {
                const transactionXDR = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].createStakingTransaction(amount, projectId);
                transactionResult = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$stellar$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stellarService"].signAndSubmitTransaction(transactionXDR);
            } catch (stellarError) {
                console.error('Stellar transaction error:', stellarError);
                // Continue with mock transaction for UI purposes
                transactionResult = {
                    hash: "mock_".concat(Date.now())
                };
            }
            ...
            addActivity({
                type: 'stake',
                title: 'Nuevo stake realizado',
                description: "Stakeaste $".concat(amount.toFixed(2), ' en "').concat(project === null || project === void 0 ? void 0 : project.title, '"'),
                amount,
                projectId
            });
            console.log("✅ Stake simulado: $".concat(amount.toFixed(2), " para proyecto ").concat(projectId));
        } catch (error) {
...
_s(AppProvider, "cvXAQSU8VR1jAkDZMIrpq5JfNZk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$hooks$2f$useWallet$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"]
    ];
});
_c = AppProvider;
function useApp() {
...
const Button = /*#__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].forwardRef(_c = (param, ref)=>{
    let { className, variant = 'primary', size = 'md', children, ...props } = param;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])(baseClasses, variants[variant], sizes[size], className),
        ref: ref,
        ...props,
        children: children
    }, void 0, false, {
...
"[project]/frontend/src/components/ui/ErrorBoundary.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=frontend_src_8ef2d507._.js.map